(function () {
  var T = {
    fr: {
      ...
      'presseur.label': 'Faire presser ses disques',
      'presseur.heading': "Le presseur qu'on recommande",
      'presseur.sub': "Vous sortez un album et vous le voulez en vinyle ? On vous envoie chez Les Disques Garcia, un atelier de pressage installé à Marciac, dans le Gers, qui fabrique pour les labels indépendants. Séries courtes, contrôle qualité sérieux, pochettes soignées. Contactez-les directement, c'est eux qui établissent le devis.",
      'presseur.cta': 'Contacter le presseur',
      'presseur.place': 'Atelier de pressage · Marciac (Gers), France',
      'presseur.spec.format': 'Format',
      'presseur.spec.format.val': 'LP 12&quot; · 140 g ou 180 g',
      'presseur.spec.pochettes': 'Pochettes',
      'presseur.spec.pochettes.val': 'Simple, gatefold, tip-on',
      'presseur.spec.tirages': 'Tirages',
      'presseur.spec.tirages.val': 'De 300 à 3 000 exemplaires',
      'presseur.spec.site': 'Site',
    ...
    en: {
      ...
      'presseur.label': 'Get your records pressed',
      'presseur.heading': 'The pressing plant we recommend',
      'presseur.sub': 'Releasing an album and want it on vinyl? We point people to Les Disques Garcia, a pressing plant based in Marciac, south-west France, that manufactures for independent labels. Short runs, strict quality control, carefully made sleeves. Contact them directly, they handle the quote.',
      'presseur.cta': 'Contact the pressing plant',
      'presseur.place': 'Vinyl pressing plant · Marciac (Gers), France',
      'presseur.spec.format': 'Format',
      'presseur.spec.format.val': 'LP 12&quot; · 140 g or 180 g',
      'presseur.spec.pochettes': 'Sleeves',
      'presseur.spec.pochettes.val': 'Single, gatefold, tip-on',
      'presseur.spec.tirages': 'Run sizes',
      'presseur.spec.tirages.val': 'From 300 to 3,000 copies',
      'presseur.spec.site': 'Website',
      'contact.label': 'Contact',
